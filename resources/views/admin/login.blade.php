...
<head>
    ...
    <link href="{{asset('public/dist/css/style.min.css')}}" rel="stylesheet">
     <link href="{{asset('public/dist/css/custom-style.css')}}" rel="stylesheet">
...
<body class="skin-default card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url({{ URL::asset('public/assets/images/background/login-register.png')}});">
