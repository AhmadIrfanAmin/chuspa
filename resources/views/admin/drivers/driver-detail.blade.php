	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">Detail Driver Info</h6>
				<h6 class="card-subtitle"></h6>

                        
                           
                                <center class="m-t-30"> <img src="{{ URL::asset('public/assets/images/users/user.png')}}" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">Gover Parker</h4>
                                    <h6 class="card-subtitle">Accoubts Manager Amix corp</h6>
                                    <div class="row text-center justify-content-md-center">
                                        <div class="col-4"><a href="javascript:void(0)" class="link"><i class="fab fa-first-order"></i> <font class="font-medium">12</font></a></div>
