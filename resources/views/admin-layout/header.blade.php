    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">WeHaul</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="{{ URL::asset('public/assets/images/logo-text.png')}}" alt="homepage" class="dark-logo" height="45" />
                         <!-- Light Logo text -->    
                         </a>
                </div>
                <!-- ============================================================== -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{ URL::asset('public/assets/images/users/user.png')}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <div class="user-pro-body">
                        <div>
                            <img src="{{ URL::asset('public/assets/images/users/user.png')}}" alt="user-img" class="img-circle">
                        </div>
                        <div class="dropdown">
